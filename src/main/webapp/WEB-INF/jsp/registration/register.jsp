...
<form method="POST" action="/EZ-TruckingService/registerSubmit">
...
<c:if test="${empty formBeanKey.id}">
   <button type="submit" class="btn btn-primary" role="button" >Create</button>
    ...
    <c:if test="${not empty formBeanKey.id}">
        ...
        <a class="btn btn-danger" role="button" href="/EZ-TruckingService/deleteUser?id=${formBeanKey.id}">Delete</a>
    </c:if>

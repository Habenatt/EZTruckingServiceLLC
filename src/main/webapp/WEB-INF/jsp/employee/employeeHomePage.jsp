...
<div id="main1">
    ...
    <div class="container">
        <table class="table table-striped" >
            ...
            <%-- <c:if test="${userListKey.size() gt 0}">

                 <h1 style="text-align: center"> <strong>List of Users Table</strong> </h1>
             ...
             <c:forEach items="${userListKey}" var="user">
                     ...
                     <tr>
                        ...
                        &lt;%&ndash; <td><b><a href="/EZ-TruckingService/register?id=${user.id}">Edit</a> </b></td>&ndash;%&gt;
                     </tr>

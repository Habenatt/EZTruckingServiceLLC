...
<div id="home2" class="container-fluid" style="  margin-top: 5%;  height:1150px;  background-size: contain ; background-repeat: no-repeat">

    <%--    <div class="container mt-5">--%>
    <div class="row" >

        <div class="col-sm-8 " style="height: 800px; background-image: url(../../../pub/images/Capture.PNG); margin-top: 5%; margin-left: 2%; border-radius: 10px;" >

                <img src="../../pub/images/leg2.PNG" style=" position: absolute; border-radius: 5px; align-items: center; margin-left: 30%;  top: 109.5%;
               transform: translateY(-50%);">

            <div class="col-sm-2  mt-2 ml-2"  >
                <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo1">Brokers</button>
                <div id="demo1" class="collapse">
                    <nav style="color: black; font-size: 120%">
                        <b> <lu ><br>
                            ...
                            <a href="#home"data-toggle="collapse" ><li>Contact Career </li></a><br>
                        </lu></b>
                    </nav>
                </div>
            ...
            <div class="col-sm-3 mt-2 ml-2"   >
                <div id="demo2" class="collapse">
                    ...
                    <form method="POST" action="">
                        ...
                        <input type="to" name="password"style="border-color: rgb(131, 6, 247);  border-width: 4px;  width: 145px"  placeholder="to"/>
                        <select name="deliveryStatus" id="delivery"  >
                            <option value="NC">NC</option>
                            <option value="TN">TN</option>
                        </select><br><br>
                        <input type="text" name="wheight" style="border-color: rgb(131, 6, 247);  border-width: 4px;  width: 145px"  placeholder="wheight"/><br><br>
                        <input type="text" name="pickupDate" style="border-color: rgb(131, 6, 247);  border-width: 4px;  width: 145px"  placeholder="pickup date & time"/><br><br>
            ...
            <div class="col-sm-3 mt-2 ml-2"   >
                <div id="demo3" class="collapse">
                    ...
                    <form method="POST" action="">
                        <input type="text" name="loadNumber"style="border-color: rgb(131, 6, 247);  border-width: 4px; margin-top: 10px; width: 145px" placeholder="Load Number or PO"/><br><br>
                        <input type="password" name="driverName"style="border-color: rgb(131, 6, 247);  border-width: 4px;  width: 145px"  placeholder="driver First name"/><br><br>
                        <input type="text" name="date" style="border-color: rgb(131, 6, 247);  border-width: 4px;  width: 145px"  placeholder="pickup date"/><br><br>
                        <input  type="submit" name="Login"  value="Submit" style="border-color: rgb(131, 6, 247); background-color: rgb(15, 225, 240);  width: 110px " />
        ...
        <div class="col-sm-2" style="margin-top: 5%; margin-left: 5%">
            <div name="butu" style=" width: 250px; height: 350px;   background-color: gainsboro; border: 2px solid rgb(5, 157, 228);
              border-radius:20px;  " >
                <img src="../../../pub/images/login2.png" style=" position: absolute; width:60px; height:60px; align-items: center; margin-left: 90px; top: 5px;
               transform: translateY(-50%);">

                <h3 style="margin-left: 65px; margin-top: 40px;">User Login</h3><br>
                <form action="/login/loginSecurityPost" method="post"  >

                    <%--    <h1 style="color:red">${errorMessage}</h1>--%>
                    <input type="text" name="username"style="border-color: rgb(131, 6, 247);  border-width: 4px; margin-left: 35px; width: 145px" placeholder="Enter Your User Name"/><br><br>
                    <input type="password" name="password"style="border-color: rgb(131, 6, 247);  border-width: 4px; margin-left: 35px; width: 145px"  placeholder="Enter Your Password"/><br><br>



                    <input id="login1" type="submit" name="Login"  value="LOGIN" style="border-color: rgb(131, 6, 247); background-color: rgb(15, 225, 240);  margin-left: 35px; width: 160px " />


                </form>

                <br>
                <p style="color:red; text-align: center; margin-top: 00px;"> <a href=""> Forgot Password </a>
                </p>
                <p style="color:red; text-align: center;"> <a href="/EZ-TruckingService/registerDriver"> Creat New Account </a>
                </p>
        ...
        <div class="col-sm-1" style="padding-bottom: 10px; margin-top: 5%">

            <img src="../../../pub/images/careers.svg" >
        </div>

    <%--    <div style="background-color:white; color:  #111111; margin-left: 4%; margin-top: 2%; height: 50px; width: 79%">--%>
        <%--        <strong style="margin-top: 100%; height: 20px; font-size:150%;">Get More Trucks</strong>--%>
        <%--    </div>--%>

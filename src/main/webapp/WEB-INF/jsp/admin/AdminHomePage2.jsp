...
<jsp:include page="../include/AdminHomeHeader2.jsp" />
...
<div id="mySidebar" class="sidebar">
    ...
    <br><br><br>
    <%--<button type="button"  data-toggle="collapse" data-target="#main2" style="margin-left: 20px">Tasks</button><br><br>


    <form method="get" action="/EZ-TruckingService/ListAllDrivers" style="margin-left: 10%">
...
<style>
    ...
    <h1 class="ml3" style="text-align: center; color: rgb(71, 92, 28); text-shadow: 3px 8px mediumaquamarine;"> ${adminListKey2} ${adminListKey.firstName} </h1><br><br>
<div class="row">
        <div class="col-sm-4   ">
    ...
    <div class="col-sm-4   ">
        ...
        <div class="col-sm-4   ">
            <h1 class="ml3" style="text-align: center; color: rgb(71, 92, 28);"> <FORM action="/admin/broker " >
            ...
            <table  class="fixed" border="5"  id="myTableData" style="text-align: center; margin-left: 30px;">
                ...
                <tr align ="center" style="background-color: cadetblue; color: rgb(56, 9, 185); " >
                   <td><b>Count</b></td>
                    ...
                    <td><b>driver Location</b></td>
                    <td><b>looking_load</b></td>
                ...
                <c:forEach items="${driverUpdateListKey}" var="user">
                    ...
                    <tr>
                        ...
                        <td><b><a href="/EZ-TruckingService/DeleteUpdateDriver?id=${user.id}"><input type="button" value = "Delete" style="background-color: #9f322c; color: #0e0a90"></a> </b></td>
                    </tr>
...
<%--                        <td><b>Delete</b></td>--%>
                    ...
                    <c:forEach items="${truckListKey}" var="user">
                        ...
                        <tr>
                            ...
                            <td>${user.year}</td>
                            <td>${user.make}</td>
                            <td><a href="/EZ-TruckingService/deleteTruck?id=${user.id}"> <input type="button" value = "Delete" style="background-color: #9f322c; color: #0e0a90"></a></td>
<%--                            <td><b><a href="/EZ-TruckingService/deleteTruck2?id=${user.id}" style="color: #8a1920">Delete</a> </b></td>--%>
                        </tr>
                ...
                <c:if test="${contactListKey.size() gt 0}">
                    <h1 style="margin-right: 410px"> <strong>Broker Contacts</strong> </h1>
                    <col width="60px" />
                    <col width="130px" />
                    <col width="150px" />
                    <col width="120px" />
                    ...
                    <c:forEach items="${contactListKey}" var="user">
                        ...
                        <tr>
                            ...
                            <td><b><a href="/EZ-TruckingService/DeleteBroker?id=${user.id}"><input type="button" value = "Delete" style="background-color: #9f322c; color: #0e0a90"></a> </b></td>
                        </tr>

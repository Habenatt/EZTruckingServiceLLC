function addRow() {
    ...
    if(userName.value=="" || Pass.value==""){
        ...
        alert ("Login successfully");
         // window.location.replace("file:///D:/haben%20Documents/PER%20SCHOLAS/Case%20Study/casestudyFInalProject2/src/main/webapp/WEB-INF/jsp/views/Drivers.jsp"); // Redirecting to other page.
